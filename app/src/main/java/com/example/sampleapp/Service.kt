            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                if (response.isSuccessful) {
                    try {
                        ...
                        // Handle responseBodyString as needed
//                        if(response.body().toString() == "Login Successful")
//
//                        {   Log.d("hey","hekllo  $responseBodyString")
//                            l.startLoginDialog(true)}
//                        else{
//                            Log.d("hey","hekl $responseBodyString" )
//                            l.startLoginDialog(false)}
//                        Log.d("loginFragment77", responseBodyString ?: "Empty response")
                        if (responseBodyString != null) {
                            if (responseBodyString.trim().equals("Login Successful", ignoreCase = true) == true) {
                    ...
                    Log.d("loginFragment","not issucessful")
    ...
    fun registerFunction(fragment: Fragment,name:String,email:String,password:String,conPassword:String,gender:String,place:String,language:String,date:String?,hour:String?){
        val call: Call<Void> = apiInterface.userDetails("Register",name, email, password, conPassword,gender,place,language,date,hour)
